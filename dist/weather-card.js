...
class WeatherCard extends LitElement {
    ...
    return html`
      <div class="current ${this.numberElements > 1 ? "spacer" : ""}" style="margin-bottom:0; padding-bottom:0;">
        <img src="${this.getWeatherIcon(
            ...
            this.hass.states["sun.sun"])}" width="140" height="140" style="width:140px; height:140px; margin-top:-60px; margin-bottom:-25px;" />
          ...
          .map(
            (daily) => html`
              <div class="day">
                ...
                ></i>
                <div class="highTemp">
                 ${Math.trunc(daily.temperature)}${this.getUnit("temperature")}
                </div>
                ${daily.templow !== undefined
                  ? html`
                      <div class="lowTemp">
                       ${Math.trunc(daily.templow)}${this.getUnit("temperature")}
                      </div>
                    `
                  : ""}
  ...
  getWeatherIcon(condition, sun) {
    return `${
      this._config.icons
        ? this._config.icons
        : "https://cdn.jsdelivr.net/gh/steven-herr/weather-card/dist/icons/"
    }${
